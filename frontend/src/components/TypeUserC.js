...
export default class TypeUserC extends Component {
    render() {
        return (
            <Fragment>
                <div className="container p-5">
                    ...
                    <div className="card mb-4" >
                        <div className="card-body">
                            ...
                            <Link to="/" className="btn btn-success btn-sm card-link ">Crear Cuenta</Link>
                        </div>
                    </div>
                    <div className="card mb-1" >
                        <div className="card-body">
                            ...
                            <Link to="/createuser" className="btn btn-success btn-sm card-link">Crear Cuenta</Link>
                        </div>
                    </div>
                </div>
            </Fragment>
